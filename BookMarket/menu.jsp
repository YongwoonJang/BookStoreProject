	...
	<div class = "container">
		...
		<div class="navbar-nav mr-auto">
			...
			<c:choose>
				...
				<li class="nav-item"><a class="nav-link" href="/BookMarket/books.jsp">상품 목록</a></li>
				<li class="nav-item"><a class="nav-link" href="/BookMarket/addBook.jsp">상품 등록</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="<c:url value="/GalleryBoardListAction.do?pageNum=1"/>">겔러리</a></li>
		</div>
	</div>
</nav>